...
# Run each model
time CUDA_VISIBLE_DEVICES="" python3 test.py $1 place_holder 0 0 Model.211-0.6870-0.9480.hdf5?dl=0 Model.253-0.7031-0.9231.hdf5?dl=0 Model.419-0.6871-1.6949.hdf5?dl=0

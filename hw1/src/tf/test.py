...
def predict_csv(in_csv, out_csv, feat_order, train_mean, train_std, train_lbl_mean, train_lbl_std, model_path):
			...
			with open(in_csv, 'r') as inf:
				...
				for line in inf:
					...
					if cur_id == None or cur_id == id:
						...
						prediction = prediction[0][0] * train_lbl_std + train_lbl_mean
...
def main():
	...
	train_mean, train_std, train_lbl_mean, train_lbl_std, feat_order = np.load(train_info_path)
	...
	predict_csv(in_csv, out_csv, feat_order, train_mean, train_std, train_lbl_mean, train_lbl_std, model_path)
